...
#Utilizamos o alfabeto ASCII para dificultar na captura dos dados
...
#O modulo utiliza um algoritimo para realizar a criptografia cifra de cesar utilizando como chave o tamanho da frase em caracteres para aumentar a segurança, para que cada frase tenha sua propria chave
...
#O modulo utiliza um algoritimo para realizar Descriptografar a cifra de cesar utilizando como chave o tamanho da frase em caracteres
